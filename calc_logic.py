...
def do_math(loanAmount, interestRate, extraPayment, loanTermYears, tax, insurance):
    ...
    monthlyPayment = calculate_monthly_payment(loanAmount, interestRate, loanTermYears, tax, insurance)
    ...
    return Balances, Months, round(totalInterest / 1000),monthlyPayment + tax/12 + insurance/12
